...
public class NewTurret : MonoBehaviour
{
    ...
    private void Shoot()
    {
        ...
        NewBullet bulletScript = bulletObj.GetComponent<NewBullet>();
    ...
    public void OpenUpgradeUI()
    {
        ...
        NewMenu cost = FindObjectOfType<NewMenu>();
    ...
    public void Upgrade()
    {
        if (CalculateCost() > LvlManager.main.currency) return;

        LvlManager.main.SpendCurrency(CalculateCost());
